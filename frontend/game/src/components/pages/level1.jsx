...
function Level1Game() {
  ...
  const calculateProgress = () => {
    return `${wordsCompleted}/${level1Words.length} words`;
  };
  ...
  const levelPassed = wordsCompleted === level1Words.length;
      ...
      <div className="game-container" style={{
        ...
        {gameOver && (
          <div style={{
            ...
            <p>Words Completed: {wordsCompleted}/{level1Words.length}</p>
